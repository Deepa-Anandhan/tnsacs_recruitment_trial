                ...
                <div className="grid grid-cols-3 mt-10 gap-10">
                    {/* <div className="lg:col-span-1 col-span-3">
                        <div className='w-full mb-10'>
                            <Link to={'SPO'} className="p-0 truncate px-3 block group relative  w-full overflow-hidden rounded-xl bg-custom-red text-lg font-semibold text-white">
                                State Prevention Officer (SPO) - 1 Posts
                                <div className="absolute inset-0 h-full w-full scale-0 rounded-lg transition-all duration-300 group-hover:scale-100 group-hover:bg-white/30"></div>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="border border-solid border-black align-middle  text-xs whitespace-nowrap p-4 ">
                                            {data.data.find(position => position.abbreviation === 'SPO')?.applicants_count || 0}
                                        </td>
                    ...
                    {/* <div className="lg:col-span-1 col-span-3">
                        <div className='w-full mb-10'>
                            <Link to={'CPO'} className="p-0 truncate px-3 block group relative  w-full overflow-hidden rounded-xl bg-custom-red text-lg font-semibold text-white">
                                Cluster Prevention Officer (CPO) - 9 Post
                                <div className="absolute inset-0 h-full w-full scale-0 rounded-lg transition-all duration-300 group-hover:scale-100 group-hover:bg-white/30"></div>
                            ...
                            <table className="items-center bg-transparent w-2/3 border rounded-lg">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="border border-solid border-black align-middle  text-xs whitespace-nowrap p-4 ">
                                            {data.data.find(position => position.abbreviation === 'CPO')?.applicants_count || 0}
