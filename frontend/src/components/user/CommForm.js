...
function CommonForm
    ...
    useEffect(()=>{
        console.log(props.first_name , "from the first name")
    } , [props.first_name])
    ...
    const validationSchema = Yup.object({
        ...
        experience: Yup.array().when('ug.degree', {
            ...
            then: () => 
                Yup.array()
                    .of(experienceSchemaa)
                    .test(
                        'only-one-currently-working',
                        'Only one experience can be marked as currently working',
                        function (experiences) {
                            const currentlyWorkingCount = experiences.filter(exp => exp.currently_working).length;
                            return currentlyWorkingCount <= 1;
                        }
                    ),
            otherwise: () => 
                Yup.array()
                                                ...
                                                <div className='border-solid border border-gray-400 rounded-md p-4'>
                                                    ...
                                                    <div className='w-15 mt-2'>
                                                        <button type='button' onClick={() => {
                                                            push({ degree: '',first_name: props.first_name,
                                                                last_name: props.last_name, register_number: '', department: '', percentage: '', marksheet: '', month: '', year: '', })
                                ...
                                {fieldarrayprops => {
                                    ...
                                    <div className='border-solid border border-gray-400 rounded-md p-4 mb-5'>
                                        {formik?.errors?.experience && typeof formik?.errors?.experience === 'string' && (
                                            <p className='text-custom-red animate-colorChange text-start text-xs font-bold' id="error_experence_all">* {formik?.errors?.experience} *</p>
                                        )}
                                        ...
                                        <div key={index} className='w-full'>
                                            ...
                                            <div className="lg:col-span-2 col-span-6">
                                                ...
                                                {errors?.experience?.[index]?.year && (
                                                        <div className="text-custom-red text-xs mt-1 font-semibold">
                                                            
                                                            <p>{errors.experience[index].year}</p>
                                                        </div>
                                                )}
                                            </div>
                                        ...
                                        <div className='w-15'>
                                        <button type='button' onClick={() => {
                                            push({ degree: '', company: '', year: '0', certificate: '', course: '' , joined_date:'' , upto_date:'',currently_working: false , year_month : '0'});
                                            validateForm();
