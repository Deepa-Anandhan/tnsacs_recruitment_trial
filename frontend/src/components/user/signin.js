        ...
        <>
            ...
            <div className="grid grid-cols-5 mt-5 gap-20 relative">
                ...
                <div className="col-span-5 flex flex-col justify-center items-center">
                    ...
                    <p className='text-custom-red font-bold mb-3  font8 border animate-colorChange border-gray-400 p-1.5 rounded-full' >Before you log
                        in for the first time, please take a moment to <small className='font-bold mb-3 font8 '>REGISTER</small> your details</p>
