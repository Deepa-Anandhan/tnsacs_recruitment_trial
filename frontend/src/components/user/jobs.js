                ...
                <div className='w-10/12 m-auto grid lg:grid-cols-11 grid-cols-1 justify-center  gap-1'>
                    <div className="col-span-4 flex flex-col gap-4 lg:mt-14 mt-0 order-2 lg:order-2">
                        {/* <div className='w-full'>
                            <Link to={'/tansacs/state_prevention_officer'} className="p-2 block group relative  w-full overflow-hidden rounded-2xl bg-red-600 text-sm font-semibold text-white">
                                State Prevention Officer
                                (SPO) - 1 Posts
                    ...
                    <div className="col-span-4 flex flex-col gap-4 lg:mt-14 mt-3 order-3">
                        {/* <Link to={'/tansacs/cluster_prevention_officer'} className="p-2 block group relative  w-full overflow-hidden rounded-2xl bg-red-600 text-sm font-semibold text-white">
