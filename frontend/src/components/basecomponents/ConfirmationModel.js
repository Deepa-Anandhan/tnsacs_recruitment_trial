...
const ConfrimModal = (props) => {
  ...
  const modelSubmitHandle = () => {
    ...
    console.log(props.formikRef.current.errors , props.formikRef.current.errors?.experience && typeof props.formikRef.current.errors?.experience === 'string');
                ...
                <div>
                  {!isValid ? (
                    ...
                    (
                      ...
                      <p>
                        please fill any one of work Experience  with in <small className='font-bold text-sm'>NACO/TANSACS</small>.
                      </p>
                    )
                  }
                </div>
