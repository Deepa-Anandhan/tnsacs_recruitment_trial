                    ...
                    props.apply ? (
                      ...
                      (<>
                        {props.main ? (
                          ...
                          <p className=" text-sm">The existing employees of  <small className='font-bold text-sm'>NACO/TANSACS</small>, the upper age limit is {props.emin_age} years as on 01.07.2024.
