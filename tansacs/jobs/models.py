...
class Job(models.Model):
    ...
    class POSITION(models.TextChoices):
        ...
        STATE_PREVENTION_OFFICER = 'State Prevention Officer (SPO)'
        CLUSTER_PREVENTION_OFFICER = 'Cluster Prevention Officer (CPO)'
...
class Experience(models.Model):
    ...
    year = models.DecimalField(max_digits=19, decimal_places=17, blank=True, null=True)
    ...
    year_month = models.CharField(max_length=50)
